  ...
  return [
    {
      ...
      name: `Global Calculator Engine - ${city.cityName} Edition`,
      url: pageUrl,
      operatingSystem: "All",
      applicationCategory: "BusinessApplication",
      description: `Localized HMRC 2026/27 compliant tax simulation engine mapping precise net pay metrics for ${city.cityName} professionals.`,
    },
    {
      "@context": "https://schema.org",
      ...
      url: pageUrl,
      description: `HMRC-authorized financial solutions managing VAT Returns, CT600 Corporation Tax, and Strategic Payroll Operations in ${city.cityName}.`,
      address: {
        "@type": "PostalAddress",
